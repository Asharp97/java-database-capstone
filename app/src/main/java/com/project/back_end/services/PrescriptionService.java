  ...
  public ResponseEntity<Map<String, Object>> getPrescription(Long appointmentId) {
    try {
      ...
      if (prescription != null) {
        ...
        return ResponseEntity.status(404).body(Map.of("message", "Prescription not found for the given appointment."));
      }

    } catch (Exception e) {
      return ResponseEntity.status(500).body(Map.of("message", "Failed to fetch prescription. " + e.getMessage()));
    }
  }
