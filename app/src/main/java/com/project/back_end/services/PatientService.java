...
public class PatientService {
  ...
  public ResponseEntity<Map<String, Object>> filterByCondition(Long patientId, String condition) {
    ...
    List<Appointment> appointments = appointmentRepository.findByPatient_IdAndStatusOrderByAppointmentTimeAsc(patientId,
        status);
    Map<String, Object> response = new HashMap<>();
    response.put("appointments", appointments);
    return ResponseEntity.ok(response);
  ...
  public ResponseEntity<Map<String, Object>> getPatientDetails(String token) {
    ...
    Patient paitent = patientRepository.findByEmail(email);

    Map<String, Object> response = new HashMap<>();
    response.put("paitent", paitent);
    return ResponseEntity.ok(response);
  }
